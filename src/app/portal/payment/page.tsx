...
export default async function PaymentPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-stone-900">Payment Information</h1>
        <p className="text-stone-500 mt-1">Manage your bank details for payroll</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardBody>
            {bankDetails ? (
              <div className="space-y-4">
                <div className="p-4 bg-stone-50 rounded-lg">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p className="font-medium text-stone-900">{bankDetails.bankName}</p>
                      <p className="text-sm text-stone-500">{formatStatus(bankDetails.accountType)} Account</p>
                    </div>
                  </div>
                  ...
                  <dl className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <dd className="text-stone-900 font-mono">****{bankDetails.last4Account}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-stone-500">Routing Number</dt>
                      <dd className="text-stone-900 font-mono">{bankDetails.routingNumber}</dd>
                    </div>
                  </dl>
                </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-stone-700">{formatDateTime(bankDetails.updatedAt)}</span>
                </div>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-stone-500">No bank details on file</p>
                <p className="text-sm text-stone-400 mt-1">Add your bank information to receive payments</p>
              </div>
            )}
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <CardBody>
            <PaymentEditForm bankDetails={bankDetails} />
          </CardBody>
        </Card>
      </div>
