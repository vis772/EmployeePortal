    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Onboarding Record */}
          {employee.documents.some(doc => doc.type === 'ONBOARDING_PDF') && (
            <Card className="border-2 border-emerald-200 bg-emerald-50">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Onboarding Record (Confidential)
                </CardTitle>
              </CardHeader>
              <CardBody>
                <p className="text-sm text-stone-600 mb-4">
                  A comprehensive PDF record of all onboarding information has been generated and securely stored. 
                  This document contains personal information, employment details, and bank information.
                </p>
                {employee.documents
                  .filter(doc => doc.type === 'ONBOARDING_PDF')
                  .map((doc) => (
                    <div key={doc.id} className="flex items-center justify-between bg-white p-4 rounded-lg border border-emerald-200">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-stone-500">
                            Generated {formatDateTime(doc.uploadedAt)}
          ...
          <Card>
            ...
            <CardBody className="p-0">
              {employee.documents.filter(doc => doc.type !== 'ONBOARDING_PDF').length === 0 ? (
